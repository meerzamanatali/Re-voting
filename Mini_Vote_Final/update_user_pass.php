...
<?php
	...
	$sql="SELECT * FROM db_evoting.tbl_reg WHERE UIN ='".$uin."'";
	$query= mysql_query($sql, $conn);
	$rows= mysql_num_rows($query);
	if($rows==1)
	{
		// Given Password is Valid
		$sql="UPDATE db_evoting.tbl_reg SET Password ='$new' WHERE UIN='$uin'"; // =============EDIT *SESSSION_SUERNAME *
